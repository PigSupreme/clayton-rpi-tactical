# -*- coding: utf-8 -*-
#
# FiniteStateMachine Basics documentation build configuration file, created by
# sphinx-quickstart on Thu Jul  9 22:13:56 2015.
#
...
htmlhelp_basename = 'FiniteStateMachineBasicsdoc'
...
latex_documents = [
  (master_doc, 'FiniteStateMachineBasics.tex', u'FiniteStateMachine Basics Documentation',
...
man_pages = [
    (master_doc, 'finitestatemachinebasics', u'FiniteStateMachine Basics Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'FiniteStateMachineBasics', u'FiniteStateMachine Basics Documentation',
   author, 'FiniteStateMachineBasics', 'One line description of project.',
   'Miscellaneous'),
]
