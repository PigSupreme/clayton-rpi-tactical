#!/usr/bin/python
"""Simple vehicles with rotation, but not using Point2d vectors
This file needed to be reworked/merged with other vehicle stuff.
"""
