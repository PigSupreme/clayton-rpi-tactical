# -*- coding: utf-8 -*-
"""
Created on Sat Apr  4 19:14:57 2015
...
class MovingObject(pygame.sprite.Sprite):
    ...
    def accelerate(self,delta_t,force=(0,0)):
        self.vel[0] = self.vel[0] + delta_t*force[0]
        self.vel[1] = self.vel[1] + delta_t*force[1]
        
    def rotate(self,delta_t):
        # Rotation about image center
        self.theta = (self.theta + self.omega*delta_t) % 360
        self.front = unit_vector_angle(self.theta)
        self.left = (-self.front[1],self.front[0])                
    ...
    def update(self,dt=1.0):
        ...
        acc = (-self.vel[1],self.vel[0])
        self.accelerate(dt,acc)        
...
img, rec = load_image('dot1.png')
angle = 0
x, y = sc_width/2, sc_height/2

# Create some objects
n = 5
obj = [MovingObject(img,rec,(x,y),20,(1,0)) for i in range(n)]
